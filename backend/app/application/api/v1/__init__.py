...
from app.application.api.v1 import health, voter_route, constituency_route, election_route, party_route, referendum_route, voting_route, biometric_route, official_route
